...
public class MAUtils
{
    ...
    public static ArrayList<String> strengthEnabled = new ArrayList<String>();
    ...
    /* ///////////////////////////////////////////////////////////////////// //
     ...
     // ///////////////////////////////////////////////////////////////////// */
    /**
     * Generates a map of wave numbers and rewards based on the type of wave ("after" or "every") and the config-file. If no keys exist in the config-file, an empty map is returned.
     */
    ...
    {
        MAUtils.bcastMsg(adminName + " - " + action, ChatColor.RED);
    }
    ...
    public static boolean isStrengthEnabled(String strength)
    {
        if (strengthEnabled.contains(strength))
        {
            return true;
        }
        return false;
    ...
    public static void downloadFile(String url, File output, boolean verbose) throws Exception
    {
        ...
        if (verbose)
        {
            log.info("[MobArena] Downloaded " + url + " to " + output.toString() + ".");
        }
    }
    ...
    /**
     * Convert a config-name to a proper spaced and capsed arena name. The input String is split around all underscores, and every part of the String array is properly capsed.
     */
    ...
    {
        return listToString(list, true, (MobArena) plugin);
    }
    ...
    public static boolean undoItHippieMonster(String name, MobArena plugin, boolean error)
    {
        ...
        catch (Exception e)
        {
            if (error)
            {
                Messenger.warning("Couldn't find backup file for arena '" + name + "'");
            }
            return false;
        }
