...
public class MobArenaHandler {
    ...
    /**
     * Primary constructor. The field 'plugin' is initalized, if the server is running MobArena.
     */
    ...
    /**
     * Get the MobArena class of a given player in a given arena. This method is faster than the above method, granted the Arena object is known.
     *
