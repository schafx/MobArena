...
public class Leaderboard
{
    ...
    /**
     * Private constructor. Creates a new leaderboard with no signs or locations or anything.
     *
    ...
    /**
     * Location constructor. Used to create a leaderboard on-the-fly from the location from the SignChangeEvent.
     *
     * @param plugin MobArena instance.
     * @param arena The arena to which this leaderboard belongs.
