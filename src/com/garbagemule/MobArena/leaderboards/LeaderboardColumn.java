...
public interface LeaderboardColumn
{
    ...
    /**
     * Get the String representation of the stat in question. The line is calculated by simply calling the appropriate getter on the ArenaPlayerStatistics object.
     *
    ...
    /**
     * Get the top sign of the column. The top sign displays the stat name.
     *
