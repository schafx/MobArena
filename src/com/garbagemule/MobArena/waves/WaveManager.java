...
public class WaveManager
{
    ...
    /**
     * Increment the wave number and get the next Wave to be spawned. Note that this method is a mutator.
     *
    ...
    /**
     * Get the next Wave to be spawned. This is an accessor and does not advance the "counter". Note that the Wave objects, however, are mutable.
     *
     * @return the next Wave
     */
    public Wave getNext()
    ...
    /**
     * Get the current wave that's being used. Note that the current wave might not have spawned yet.
     *
