...
public class WaveParser {
    ...
    /**
     * Scan the ConfigSection for a "monster" (singular) node, which must be exactly a single monster.
     *
    ...
    /**
     * Scan the ConfigSection for a "monsters" (plural) node, which must contain a list of at least one "monster: number" node.
     *
     * @param config
