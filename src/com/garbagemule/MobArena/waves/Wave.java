...
public interface Wave
{
    ...
    /**
     * Get a list of spawnpoints upon which the monsters of this wave may be spawned. Note that it is expected that the getMonstersToSpawn() method is called first, and that each monster is
     * then spawned on a location given in the list from this method.
     *
     * @param arena an Arena
    ...
    /**
     * Set the list of spawnpoints on which the monsters of this wave may be spawned. If the value is null, all spawnpoints of the arena region will be considered.
     *
    ...
    /**
     * Check if this wave matches the wave number. The SingleWave class does a simple check if its wave == the parameter. The RecurrentWave class is more complex in that it needs to do some
