...
public class MABoss {
    ...
    /**
     * Check if the boss is dead. A boss is dead if it has been damaged such that its health is below 0.
     *
    ...
    /**
     * Set the death status of a boss. This is used by the ArenaListener to force kill bosses that die due to unhandled damage events (Bukkit issues).
     *
