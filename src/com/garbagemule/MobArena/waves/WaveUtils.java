...
public class WaveUtils {
    ...
    /*////////////////////////////////////////////////////////////////////
     ...
     ////////////////////////////////////////////////////////////////////*/
    /**
     * Check if a wave in the config-file is well-defined. The method first checks if the wave is well-defined according to the branch-specific requirements. Recurrent waves must have the
     * two nodes 'priority' and 'frequency', and single waves must have the node 'wave'. Any other requirements are type-specific, and thus we check if the type is well-defined.
     *
    ...
    /**
     * Check if a wave type in the config-file is well-defined. The method calls the appropriate sub-method to check if the type is well-defined.
     *
     * @param config Config-file Config
     * @param path The absolute path of the wave
     * @param type The wave type
    ...
    /**
     * Check if a default wave is well-defined. The default waves have an optional wave growth node. Otherwise, they share nodes with special waves.
     *
     * @param config Config-file Config
     * @param path The absolute path of the wave
     * @param wellDefined Pass-through boolean for "leaf methods".
    ...
    /**
     * Check if a special wave is well-defined. The special waves have no unique nodes.
     *
     * @param config Config-file Config
     * @param path The absolute path of the wave
     * @param wellDefined Pass-through boolean for "leaf methods".
    ...
    /**
     * Check if a default or special wave is well-defined. There are no REQUIRED nodes for default or special wave types, besides the ones for the branch they belong to. The only OPTIONAL
     * node is (currently) 'monsters'
     *
     * @param config Config-file Config
     * @param path The absolute path of the wave
     * @param wellDefined Pass-through boolean for "leaf methods".
    ...
    /**
     * Get a Comparator that compares Wave objects by wave number. If the wave numbers are equal, the waves are equal. This is to DISALLOW "duplicates" in the SINGLE WAVES collection.
     *
    ...
    /**
     * Get a Comparator that compares Wave objects by priority. If the priorities are equal, the names are compared. This is to ALLOW "duplicates" in the RECURRENT WAVES collection.
     *
