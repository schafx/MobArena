...
public class ScoreboardManager {
    ...
    /**
     * Add a player to the scoreboard by setting the player's scoreboard and giving him an initial to-be-reset non-zero score.
     *
    ...
    /**
     * Remove a player from the scoreboard by setting the player's scoreboard to the main server scoreboard.
     *
     * @param player a player
     */
