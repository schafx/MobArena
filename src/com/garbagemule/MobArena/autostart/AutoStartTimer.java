...
public class AutoStartTimer
{
    ...
    /**
     * Starts the timer. The method is idempotent, meaning if the timer was already started, nothing happens if the method is called again.
     */
    public void start()
    {
    ...
    /**
     * The internal timer class used for the auto-join-timer setting. Using an extra internal object allows the interruption of a current timer, followed by the creation of a new. Thus, no
     * timers should ever interfere with each other.
     */
